...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_4_VERSION_ON:                         r = SPORK_4_VERSION_ON_DEFAULT; break;
            ...
            case SPORK_19_SIGMA_NEW:                         r = SPORK_19_SIGMA_NEW_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_4_VERSION_ON:                         return SPORK_4_VERSION_ON_DEFAULT;
        ...
        case SPORK_19_SIGMA_NEW:                         return SPORK_19_SIGMA_NEW_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_4_VERSION_ON")                     return SPORK_4_VERSION_ON;
    ...
    if (strName == "SPORK_19_SIGMA_NEW")                     return SPORK_19_SIGMA_NEW;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_4_VERSION_ON:                         return "SPORK_4_VERSION_ON";
        ...
        case SPORK_19_SIGMA_NEW:                         return "SPORK_19_SIGMA_NEW";
