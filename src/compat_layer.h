...
#define COMPAT_LAYER_H
         ...
         #define BZX_UNUSED [[maybe_unused]]
    #elif defined(HAVE_ATTRIBUTE_UNUSED)
         #define BZX_UNUSED __attribute__((unused))
    #else
         #define BZX_UNUSED
    #endif
#else
    // In C mode, if the compiler supports __attribute__((unused)), use it.
       ...
       #define BZX_UNUSED
        ...
        #define BZX_FALLTHROUGH [[fallthrough]]
    #elif !defined(__clang__) && defined(__has_attribute)
        #if __has_attribute(gnu::fallthrough)
            #define BZX_FALLTHROUGH [[gnu::fallthrough]]
        #endif
    #elif defined(__has_attribute) && __has_attribute(fallthrough)
        #define BZX_FALLTHROUGH __attribute__((fallthrough))
